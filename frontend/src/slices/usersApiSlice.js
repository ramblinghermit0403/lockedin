...
const USERS_URL = `${process.env.REACT_APP_TARGET_URL}/users`;
const USER_STATUS_URL = `${process.env.REACT_APP_TARGET_URL}/user/status`;
const USER_MEAL_PLAN_URL = `${process.env.REACT_APP_TARGET_URL}/user/meal-plan`;
const USER_WATER_INTAKE_URL = `${process.env.REACT_APP_TARGET_URL}/users/water-intake`;
